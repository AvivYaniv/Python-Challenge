...
letterWithBodyguards = re.findall(r'[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]', str)

littles = ""

for i in range(len(letterWithBodyguards)):
    #print letterWithBodyguards[i]
    #print letterWithBodyguards[i][4]
    littles += letterWithBodyguards[i][4]
